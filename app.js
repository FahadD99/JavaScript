...
// Using a for-loop, create a function using arrows - thank you Dan- great idea
alienData.forEach((alienSighting) => {
    ...
    Object.entries(alienSighting).forEach(([key,value]) => {
        ...
        // For city, capitalize the first letter- appreciate the guidance Dan 
        else if (key == 'city') {
            if(value.includes('(')) {
...
// Using a for-loop, create a function to create dropdown for states - Thank you Dan for clarifying helping to use this code. 
